...
def grid_search_all_by_n_components(estimators_list, param_grids, estimators_names, X, y, n_components, pca_kernels_list=None, random_state=0, show_plots=False, show_errors=False, verbose=0, plot_dest="figures", debug_var=False, avoid_func=False, flag_no_computation=False, show_widget=False):
    # debug_var = False
    ...
    for ii, (estimator_obj, estimator_name) in enumerate(zip(estimators_list, estimators_names)):
        ...
        if debug_var is False:
            grid_res = grid_search_by_n_components(estimator_obj, param_grids[ii], X, y, n_components, estimator_name, show_widget=show_widget, kernels_list=pca_kernels_list, random_state=0, show_plots=False, show_errors=False, verbose=verbose, plot_dest=plot_dest_list[ii], estimator_name=estimator_name, flag_no_computation=flag_no_computation)
...
def grid_search_by_n_components(estimator, param_grid, X, y, n_components, clf_type, kernels_list=None, random_state=0, show_plots=False, show_errors=False, verbose=0, plot_dest="figures", estimator_name=None, ignore_func=False, flag_no_computation=False, show_widget=False):
